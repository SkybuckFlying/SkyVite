...
1. **Check existing branches**
   ```
   git branch -r | grep "Branch/Workspace/Translator/Gemini2.5Pro/AI0006/Session/"
   ```
   Example output:
   ```
   Branch/Workspace/Translator/Delphi/Gemini2.5Pro/AI0006/Session/0001
   Branch/Workspace/Translator/Delphi/Gemini2.5Pro/AI0006/Session/0002
   ```
...
3. **Create translator branch**
   ```
   git checkout -b Branch/Workspace/Translator/Gemini2.5Pro/AI0006/Session/0003
   ```
...
3. **Create translator branch (with detected session)**
   ```
   git checkout -b Branch/Workspace/Translator/Delphi/Gemini2.5Pro/AI0006/Session/0003
   ```
...
5. **Stage and commit changes**
   ```
   git add .
   git commit -m "Translator, Gemini 2.5 Pro, AI0006, Session 0003: translated Go sources into Delphi units"
   ```

6. **Push translator branch**
   ```
   git push Repository Branch/Workspace/Translator/Gemini2.5Pro/AI0006/Session/0003
   ```

7. **Stop here**
   - Do not merge into `/Branch/Develop/Delphi`.
...
2. **Sequentially merge translator branches in order**
   ```
   git merge --no-ff Branch/Workspace/Translator/Delphi/Gemini2.5Pro/AI0001/Session/0001
   git merge --no-ff Branch/Workspace/Translator/Delphi/Gemini2.5Pro/AI0002/Session/0001
   git merge --no-ff Branch/Workspace/Translator/Delphi/Gemini2.5Pro/AI0003/Session/0001
   ...
   ```
...
- **Workers**:
  ...
  - Never touch `Branch/Develop/Delphi` directly.

- **Coordinator**:
  - Integrates translator branches into `Branch/Develop/Delphi`.
