unit Vendor.Golang.Org.X.Crypto.Sha3.Keccakf;
...
procedure KeccakF1600(var A: array of UInt64);
...
procedure KeccakF1600(var A: array of UInt64);
var
  T, BC0, BC1, BC2, BC3, BC4, D0, D1, D2, D3, D4: UInt64;
  I: Integer;
begin
  for I := 0 to 5 do // Unrolling 4 rounds per loop, 24/4 = 6 iterations
  begin
    // Round implementation based on Go code...
