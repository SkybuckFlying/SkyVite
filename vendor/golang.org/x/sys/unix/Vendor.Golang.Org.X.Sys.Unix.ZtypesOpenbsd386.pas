{$MODE DELPHIUNICODE}
unit Vendor.Golang.Org.X.Sys.Unix.ZtypesOpenbsd386;
...
type
    ...
    Dirent = record
        ...
        mType         : UInt8;
        mNamlen       : UInt8;
        mX__d_padding : array[0..3] of UInt8;
...
const
    ConstSizeofIfMsghdr         = $ec;
    ConstSizeofIfData           = $d4;
...
type
    Uvmexp = record
        ...
        mSyscalls           : Int32;
        mPageins            : Int32;
        mObsolete_swapins   : Int32;
        mObsolete_swapouts  : Int32;
        mPgswapin           : Int32;
        mPgswapout          : Int32;
        mForks              : Int32;
        mForks_ppwait       : Int32;
